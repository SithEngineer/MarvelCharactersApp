...
import io.github.sithengineer.marvelcharacters.presentation.adapter.SmallComicBookAdapter
...
import io.github.sithengineer.marvelcharacters.presentation.MarvelImageView
...
class CharacterDetailsFragment : Fragment(),
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    val itemDecoration = SpacingItemDecoration(
        DisplayUtils.convertDpToPixel(context, 10),
        isVertical = false)
  ...
  override fun showCharacterDetails(character: Character) {
    character.thumbnail?.let {
      val uri = getImageUrlFrom(it)
      characterImage.controller =
          Fresco.newDraweeControllerBuilder()
              .setOldController(characterImage.controller)
