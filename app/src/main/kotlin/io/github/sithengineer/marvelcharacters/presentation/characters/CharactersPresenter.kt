...
import io.github.sithengineer.marvelcharacters.presentation.characters.CharactersContract.View
...
class CharactersPresenter(
  ...
  private fun loadCharacters(isFirstBatch: Boolean = false) {
    ...
    val request = GetCharacters.Request(charactersOffset,
        CHARACTERS_FETCH_LIMIT)
